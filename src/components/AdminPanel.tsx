        ...
        >
          ...
          >
            <button
              type="button"
              onClick={() => setIsAuthModalOpen(false)}
              className="absolute top-4 right-4 text-zinc-400 hover:text-white p-1 rounded hover:bg-zinc-900"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <form onSubmit={handleContentSave} className="p-6 overflow-y-auto flex-1 space-y-6">
              ...
              {activeTab === "home_hero" && (
                <div className="space-y-4">
                  <div className="border border-zinc-800 rounded-lg p-4 space-y-3 bg-zinc-900/40">
                    ...
                    <textarea rows={2} value={formData.home.heroTitle} onChange={(e) => setFormData({ ...formData, home: { ...formData.home, heroTitle: e.target.value } })} className="w-full bg-zinc-900 border border-zinc-800 rounded px-3 py-2 text-sm text-white" placeholder="Hero Title" />
              ...
              {activeTab === "home_cards" && (
                <div className="space-y-4">
                  ...
                  <div className="border border-zinc-800 rounded-lg p-4 space-y-3 bg-zinc-900/40">
                    <h4 className="font-bold text-xs uppercase text-[#07b4ba]">Card 1: 1-on-1 Transformation (With Bullet Points)</h4>
                  ...
                  <div className="border border-zinc-800 rounded-lg p-4 space-y-3 bg-zinc-900/40">
                    <h4 className="font-bold text-xs uppercase text-[#07b4ba]">Card 2: 30-Day Program (With Bullet Points)</h4>
              ...
              {activeTab === "prog_hero_pain" && (
                <div className="space-y-4">
                  <div className="border border-zinc-800 rounded-lg p-4 space-y-3 bg-zinc-900/40">
                    ...
                    <textarea rows={2} value={formData.program.heroTitle} onChange={(e) => setFormData({ ...formData, program: { ...formData.program, heroTitle: e.target.value } })} className="w-full bg-zinc-900 border border-zinc-800 rounded p-2 text-sm text-white" placeholder="Title" />
              ...
              {activeTab === "prog_reviews" && (
                <div className="space-y-4">
                  <div className="border border-zinc-800 rounded-lg p-4 space-y-3 bg-zinc-900/40">
                    ...
                    <input type="text" value={formData.program.testimonialHeading} onChange={(e) => setFormData({ ...formData, program: { ...formData.program, testimonialHeading: e.target.value } })} className="w-full bg-zinc-900 border border-zinc-800 rounded p-2 text-sm text-white" placeholder="Heading" />
              ...
              {activeTab === "prog_bonuses" && (
                <div className="space-y-4">
                  <div className="border border-zinc-800 rounded-lg p-4 space-y-3 bg-zinc-900/40">
                    ...
                    <input type="text" value={formData.program.bonusHeading} onChange={(e) => setFormData({ ...formData, program: { ...formData.program, bonusHeading: e.target.value } })} className="w-full bg-zinc-900 border border-zinc-800 rounded p-2 text-sm text-white" placeholder="Heading" />
              ...
              {activeTab === "prog_cta" && (
                <div className="space-y-4">
                  <div className="border border-zinc-800 rounded-lg p-4 space-y-3 bg-zinc-900/40">
                    ...
                    <input type="text" value={formData.program.ctaHeading} onChange={(e) => setFormData({ ...formData, program: { ...formData.program, ctaHeading: e.target.value } })} className="w-full bg-zinc-900 border border-zinc-800 rounded p-2 text-sm text-white" placeholder="Heading" />
                  ...
                  <div className="border border-zinc-800 rounded-lg p-4 space-y-3 bg-zinc-900/40">
                    ...
                    <input type="text" value={formData.program.ctaCardHeading} onChange={(e) => setFormData({ ...formData, program: { ...formData.program, ctaCardHeading: e.target.value } })} className="w-full bg-zinc-900 border border-zinc-800 rounded p-2 text-sm text-white" placeholder="Card Main Heading" />
