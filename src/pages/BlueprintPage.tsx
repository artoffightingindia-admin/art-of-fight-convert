          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-[16px]">
            {whatCards.map((item, i) => (
              <Reveal key={i} type="scale-up" delay={i * 150} duration={800}>
                <div className="w-full p-5 rounded-[16px] bg-gradient-to-b from-[#13171d] to-[#101318] border border-white/5 flex flex-col items-center text-center gap-4 md:min-h-[290px] md:p-[26px]">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5 mt-4 md:mt-6">
                {stats.map((stat, i) => (
                  <Reveal key={i} type="scale-up" delay={400 + i * 100} duration={800}>
                    <div className="bg-gradient-to-b from-[#181818] to-[#121212] border border-white/10 rounded-[14px] min-h-[95px] md:h-[140px] p-3 md:p-4 text-center flex flex-col justify-center">
