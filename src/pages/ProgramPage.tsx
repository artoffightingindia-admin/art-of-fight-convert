            ...
            <div className="flex-1 min-w-[260px]">
              <Reveal>
                ...
                <div className="mt-7 flex flex-col items-start gap-2">
                  ...
                  <button className="inline-flex items-center gap-2.5 bg-[#25D366] text-white py-3.5 px-7 rounded-full font-['Barlow'] font-bold text-[15px] border-none cursor-pointer hover:bg-[#1ebe57] transition-colors shadow-[0_4px_18px_rgba(37,211,102,.35)]">
