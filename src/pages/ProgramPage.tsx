...
const css = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .pp-hero-h1 { font-family: 'Bebas Neue', sans-serif; font-size: clamp(42px, 5.5vw, 72px)); line-height: 0.92; letter-spacing: 3px; color: #fff; margin-bottom: 14px; max-width: 820px; }
