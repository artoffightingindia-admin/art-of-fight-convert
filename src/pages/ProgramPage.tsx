...
const css = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .pp-hero {
    ...
    display: flex;
    align-items: center;
    /* LEFT-ALIGN: no justify-content center, content starts from left edge + padding */
    justify-content: flex-start;
    overflow: hidden;
    /* Consistent padding on ALL screen sizes — never auto-centers */
  ...
  .pp-hero-content {
    position: relative;
    z-index: 2;
    /* No max-width, no margin:auto — content always starts at the left padding edge */
    display: flex;
    flex-direction: column;
    align-items: flex-start;
    text-align: left;
    /* Cap content width so text doesn't stretch too wide on ultra-wide screens */
    max-width: 640px;
  }
  .pp-hero-h2 {
    color: #07b4ba;
  ...
  .pp-hero-h1 {
    font-family: 'Bebas Neue', sans-serif;
    /* clamp: min 40px, scales with viewport, max 72px — consistent visual weight everywhere */
  ...
  /* ───────── TRUST BAR ───────── */
  .pp-trust-strip {
    /* Full bleed — no side padding that would create gaps */
    width: 100%;
    background: #07b4ba;
    display: flex;
    align-items: center;
    justify-content: space-evenly;
    /* Vertical padding only — horizontal handled by flex spacing */
    padding: 14px 0;
    gap: 0;
    flex-wrap: nowrap;
    position: relative;
  ...
  .pp-trust-item { display: flex; align-items: center; gap: 12px; flex: 1; justify-content: center; }
  .pp-trust-icon { width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
  .pp-trust-icon svg { width: 28px; height: 28px; stroke: #fff; fill: none; stroke-width: 2; }
  .pp-trust-item p { font-family: 'Bebas Neue', sans-serif; font-size: 22px; letter-spacing: 2px; color: #ffffff; line-height: 1; white-space: nowrap; }

  /* SECTION WRAPPER */
  .pp-section { max-width: 1100px; margin: 0 auto; padding: 56px 40px; }

  /* PAIN */
  .pp-problem { background: #0b0b0b; }
  .pp-problem-grid { display: flex; gap: 56px; align-items: center; flex-wrap: wrap; }
  .pp-problem-left { flex: 1; min-width: 280px; }
  ...
  /* FIX: problem-right uses flex instead of fixed width */
  ...
  /* FIX: coach stats use CSS grid instead of fixed widths */
  .pp-coach-stats {
    display: grid;
  ...
  /* FOOTER CTA */
  .pp-footer-cta { background: #0b0b0b; position: relative; z-index: 10; }
  .pp-footer-grid {
    display: flex;
    gap: 28px;
    align-items: center;
  ...
  .pp-offer-label { font-family: 'Bebas Neue', sans-serif; font-size: 11px; letter-spacing: 2px; color: #07b4ba; margin-bottom: 6px; }
  .pp-offer-h { font-family: 'Bebas Neue', sans-serif; font-size: clamp(22px,3vw,34px); letter-spacing: 1px; color: #fff; line-height: 1; margin-bottom: 18px; }
  .pp-timer { display: flex; gap: 8px; margin-bottom: 6px; }
  .pp-timer-block { text-align: center; }
  .pp-timer-block h3 { font-family: 'Bebas Neue', sans-serif; font-size: clamp(24px,3vw,34px); letter-spacing: 1px; color: #07b4ba; line-height: 1; background: #111; border: 1px solid rgba(7,180,186,0.2); border-radius: 6px; padding: 6px 10px; min-width: 50px; }
  .pp-timer-block p { font-family: 'Barlow', sans-serif; font-size: 9px; color: rgba(255,255,255,0.4); text-transform: uppercase; letter-spacing: 1px; margin-top: 4px; }
  .pp-timer-sep { font-family: 'Bebas Neue', sans-serif; font-size: 26px; color: rgba(255,255,255,0.3); align-self: flex-start; padding-top: 4px; }
  .pp-last-day { font-family: 'Barlow', sans-serif; font-size: 10px; color: rgba(255,255,255,0.35); letter-spacing: 1px; font-style: italic; }
  .pp-price-box { background: #111; border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 16px 14px; max-width: 200px; margin: 0 auto; }
  ...
  /* BONUS TOTAL ROW — FIX: no more absolute pixel hacks */
  .pp-bonus-total-row {
    display: flex;
    align-items: center;
    gap: 32px;
  ...
  @media (max-width: 1024px) {
    ...
    .pp-feature-card { width: calc(33.333% - 10px); min-width: 160px; }
    .pp-coach-stats { grid-template-columns: repeat(2, 1fr); }
    .pp-problem-right { flex: 0 0 min(400px, 45%); }
  }

  @media (max-width: 768px) {
    .pp-nav { padding: 12px 16px; }
    .pp-section { padding: 48px 20px !important; }
    ...
    .pp-hero { padding: 110px 5vw 60px; min-height: auto; }
    .pp-hero-content { max-width: 100%; }
    .pp-hero-h1 { font-size: clamp(32px, 8vw, 52px); }
    .pp-hero-h2 { font-size: 11px; }
    .pp-hero-desc { font-size: 14px; max-width: 100%; }
    .pp-join-btn { width: 100%; }
    .pp-trust-strip { flex-wrap: wrap; padding: 12px 0; gap: 0; }
    .pp-trust-item { width: 50%; flex: unset; justify-content: center; padding: 6px 0; }
    .pp-trust-item p { font-size: 12px; letter-spacing: 0.5px; white-space: nowrap; }
    .pp-trust-icon { width: 24px; height: 24px; }
    .pp-trust-icon svg { width: 18px; height: 18px; }
    .pp-features-heading { font-size: 38px; margin-bottom: 36px; }
    .pp-features-grid { flex-direction: column; }
    .pp-feature-card { width: 100%; min-height: auto; padding: 22px 18px; border-radius: 16px; flex-direction: row; align-items: flex-start; text-align: left; gap: 18px; background: linear-gradient(180deg,#13171d 0%,#101318 100%); border: 1px solid rgba(255,255,255,0.06); }
    .pp-feature-card h4 { min-height: auto; justify-content: flex-start; text-align: left; font-size: 16px; }
    .pp-feature-card p { min-height: auto; justify-content: flex-start; text-align: left; font-size: 13px; }
    .pp-feature-icon { width: 58px; height: 58px; flex-shrink: 0; }
    .pp-feature-icon svg { width: 40px; height: 40px; }
    .pp-coach-stats { grid-template-columns: repeat(2, 1fr); max-width: 100%; }
    .pp-apply-grid { grid-template-columns: 1fr !important; gap: 42px !important; }
    .pp-apply-grid button { width: 100%; }
    .pp-footer-inner { grid-template-columns: 1fr; gap: 32px; }
    ...
    .pp-feedback-mobile-card { width: 100%; min-height: 60px; padding: 32px 28px; border: 1px solid rgba(141,150,168,0.22); border-radius: 22px; background: #171a21; }
    .pp-feedback-mobile-stars { display: flex; gap: 10px; margin-bottom: 28px; color: #07b4ba; font-size: 30px; line-height: 1; }
    .pp-feedback-mobile-text { margin: 0 0 28px !important; color: rgba(189,195,208,0.78) !important; font-family: 'Barlow', sans-serif !important; font-size: 20px !important; font-style: italic !important; font-weight: 400 !important; line-height: 1.72 !important; }
    .pp-feedback-mobile-author { display: flex; align-items: center; gap: 22px; }
    .pp-feedback-avatar { position: relative; width: 60px; height: 60px; flex-shrink: 0; border-radius: 50%; background: #262b35; }
    .pp-feedback-avatar::before { content: ""; position: absolute; top: 16px; left: 50%; width: 12px; height: 12px; transform: translateX(-50%); border: 3px solid #929aaa; border-radius: 50%; }
    .pp-feedback-avatar::after { content: ""; position: absolute; left: 50%; bottom: 14px; width: 22px; height: 14px; transform: translateX(-50%); border: 3px solid #929aaa; border-bottom: 0; border-radius: 12px 12px 0 0; }
    .pp-feedback-mobile-author p { margin: 0 0 6px !important; color: #fff !important; font-family: 'Barlow', sans-serif !important; font-size: 20px !important; font-weight: 800 !important; line-height: 1 !important; }
    .pp-feedback-mobile-author span { color: #9da5b6; font-family: 'Barlow', sans-serif; font-size: 16px; line-height: 1; }
    .pp-feedback-mobile-nav { display: flex; justify-content: center; gap: 24px; margin-top: 40px; }
    .pp-feedback-mobile-nav button { display: flex; align-items: center; justify-content: center; width: 56px; height: 56px; border: 2px solid rgba(141,150,168,0.28); border-radius: 50%; background: rgba(7,10,16,0.35); color: #a6adbd; font-size: 36px; line-height: 1; cursor: pointer; }
    ...
    .pp-bonus-total-row { flex-direction: column; align-items: flex-start; gap: 16px; }
    .pp-bonus-total-right { padding-left: 0; border-left: none; border-top: 1px solid rgba(255,255,255,0.14); padding-top: 16px; width: 100%; }
  ...
  @media (max-width: 768px) {
    ...
    .pp-roadmap-card { position: relative; flex: 0 0 82vw; min-height: 308px; overflow: hidden; border: 1px solid rgba(116,225,232,0.28); border-radius: 10px; background: #061018; }
...
const IconAudio = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="#07b4ba" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="52" height="52">
    ...
    <rect x="2" y="12" width="4" height="8" rx="2" /><rect x="18" y="12" width="4" height="8" rx="2" />
  </svg>
);
...
export default function ProgramPage() {
  ...
  // FIX: compute card width dynamically from DOM instead of using hardcoded 47%
  const getDesktopSlideOffset = (index: number) => {
    if (!roadmapTrackRef.current) return "0px";
    const cards = roadmapTrackRef.current.querySelectorAll(".roadmap-card");
    if (!cards.length) return "0px";
      ...
      <div className="pp">
        ...
        <div className={isMobileRoadmap ? "pp-roadmap pp-roadmap-mobile" : "pp-roadmap"} style={{ background: "#0b0b0b", position: "relative", overflow: "hidden" }}>
          <div style={{ maxWidth: 1400, margin: "0 auto", padding: "30px 0", backgroundImage: "repeating-linear-gradient(-45deg, rgba(7,180,186,0.04) 0px, rgba(7,180,186,0.04) 1px, transparent 1px, transparent 6px)" }}>
            ...
            {isMobileRoadmap ? (
              ...
              /* FIX: Desktop roadmap uses CSS calc() with actual card widths instead of 47% percentage */
              <div style={{ position: "relative", maxWidth: 1320, margin: "0 auto", overflow: "hidden", padding: "0 70px" }}>
                ...
                {/* FIX: use ref + CSS var to avoid hardcoded 47% that breaks on different viewport widths */}
                <div style={{ overflow: "hidden" }}>
                  ...
                  >
                    {roadmapCards.map((card, i) => (
                      <div key={i} className="roadmap-card" style={{ minWidth: "calc(50% - 10px)", borderRadius: 22, overflow: "hidden", background: "linear-gradient(180deg,#10151d 0%, #0b0f14 100%)", border: "1px solid rgba(255,255,255,0.06)" }}>
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: 90 }}>
                          ...
                          <div style={{ padding: "32px 24px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                            <h3 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(28px, 3vw, 42px)", color: "#fff", marginBottom: 18 }}>{card.title}</h3>
                            <div style={{ width: 60, height: 3, background: "#07b4ba", marginBottom: 20 }} />
                            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                              {card.points.map((point, idx) => (
                                <div key={idx} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                                  <div style={{ width: 20, height: 20, borderRadius: "50%", border: "2px solid #07b4ba", color: "#07b4ba", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, flexShrink: 0 }}>✓</div>
            ...
            <Reveal>
              ...
              <div style={{ display: "flex", gap: 56, alignItems: "flex-start", flexWrap: "wrap" }}>
                ...
                <div style={{ flex: 1, minWidth: 280 }}>
                  ...
                  {/* FIX: coach stats now use CSS grid class instead of fixed pixel widths */}
                  <div className="pp-coach-stats">
                    {stats.map((stat, i) => (
                      <div key={i} className="pp-coach-stat-box">
                        <p className="pp-coach-stat-val">{stat.val}</p>
                        <p className="pp-coach-stat-label">{stat.label}</p>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <div style={{ background: "#0b0b0b", position: "relative", overflow: "hidden", backgroundImage: "linear-gradient(rgba(7,180,186,0.05) 1px, transparent 0.4px), linear-gradient(90deg, rgba(7,180,186,0.05) 1px, transparent 0.4px)", backgroundSize: "32px 32px" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto", padding: "40px 20px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 8 }}>
              {[
                ...
                <div key={i} style={{ background: "linear-gradient(180deg,#0e141c 0%, #0a0f14 100%)", border: "1px solid rgba(7,180,186,0.35)", borderRadius: 18, padding: "10px 12px", position: "relative", overflow: "hidden", minHeight: 220, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
                  ...
                  <div style={{ width: 70, height: 70, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 7, marginTop: 15 }}>
            ...
            {/* FIX: bonus total row — no more absolute pixel hacks */}
            <div style={{ marginTop: 12, border: "1px solid rgba(7,180,186,0.35)", borderRadius: 18, padding: "20px 28px", background: "linear-gradient(90deg,#0f141a 0%, #0a0f14 100%)" }}>
              <div className="pp-bonus-total-row">
                <div className="pp-bonus-total-left">
                  <img src="https://i.postimg.cc/pr1bYVdc/Chat-GPT-Image-May-22-2026-12-03-35-AM.png" alt="Gift Box" style={{ width: 80, height: 80, objectFit: "contain", filter: "drop-shadow(0 0 10px rgba(255,215,0,0.35))", flexShrink: 0 }} />
                  <div>
                    <p className="pp-bonus-total-label">TOTAL BONUS VALUE</p>
                    <h2 className="pp-bonus-total-val">₹7,499</h2>
                  </div>
                </div>
                <div className="pp-bonus-total-right">
                  <p style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(28px, 3vw, 40px)", letterSpacing: 2, color: "#fff", lineHeight: 1 }}>YOURS 100% FREE</p>
            ...
            <div className="pp-apply-grid">
              <div>
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: 32, flexWrap: "wrap", marginBottom: 28 }}>
                  ...
                  <button style={{ display: "flex", alignItems: "center", gap: 10, height: 52, padding: "0 24px", borderRadius: 999, border: "none", background: "#25D366", color: "#fff", fontFamily: "'Barlow', sans-serif", fontWeight: 700, fontSize: 15, cursor: "pointer", flexShrink: 0, boxShadow: "0 4px 18px rgba(37,211,102,0.35)", alignSelf: "flex-end" }}>
