...
const css = `
 ...
 .pp-trust-item { display: flex; align-items: center; gap: 12px; }
  ...
  .pp-feature-card { width: 190px; min-height: 255px; padding: 11px 6px; border-radius: 18px; background: #111417; border: 2px solid #111417; text-align: center; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 18px; }
