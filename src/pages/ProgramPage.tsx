...
const css = `
  ...
  * { word-break: break-word; }
  ...
  .pp-nav-left { display: flex; align-items: center; }
  .pp-nav-logo {
    display: flex; align-items: center;
    font-family: 'Bebas Neue', sans-serif; font-size: 30px; line-height: 1; margin: 0;
  }
  ...
  /* ── HERO ──
     KEY FIX: removed all negative margins from hero children.
     Content is centred via max-width + auto margins and left-aligned with text-align.
  */
  .pp-hero {
    position: relative;
    min-height: 78vh;
  ...
  .pp-problem-right { flex: 1; min-width: 280px; max-width: 500px; }
  .pp-problem-right img { width: 100%; border-radius: 14px; border: 1px solid rgba(255,255,255,0.1); aspect-ratio: 16/9; object-fit: cover; }
  ...
  .pp-feature-card h4 {
    ...
    font-size: clamp(14px, 1.4vw, 17.5px); letter-spacing: 2px; line-height: 1.3;
    min-height: 58px; margin: 0 0 4px;
    display: flex; align-items: flex-start; justify-content: center; text-align: center;
  }
  .pp-feature-card p {
    font-size: clamp(12px, 1.2vw, 14px); line-height: 1.55;
    color: rgba(255,255,255,0.62); text-align: center; margin: 0; min-height: 44px;
  ...
  .cp-new-promise-text { font-family: 'Barlow', sans-serif; font-size: clamp(15px, 1.6vw, 19px); line-height: 1.9; color: rgba(255,255,255,0.76); font-style: italic; max-width: 720px; margin: 0 auto; }
  .cp-new-promise-title { font-family: 'Bebas Neue', sans-serif; font-size: clamp(22px, 2.5vw, 30px); letter-spacing: 2px; color: #fff; margin-bottom: 12px; text-align: center; }
  .cp-quote-mark { color: #07b4ba; font-size: 42px; line-height: 0; margin-right: 6px; font-family: serif; position: relative; top: 10px; }

  /* ── FOOTER CTA ── */
  .pp-footer-cta { background: #0b0b0b; }
  ...
  .pp-coach-stats > div p:first-child { font-family: 'Bebas Neue', sans-serif; font-size: clamp(32px, 3.5vw, 42px); color: #07b4ba; letter-spacing: 1px; margin-bottom: 10px; }
  ...
  .pp-footer-links a, .pp-footer-contact p, .pp-footer-about p { font-family: 'Barlow', sans-serif; font-size: 15px; color: rgba(255,255,255,0.52); text-decoration: none; transition: color 0.2s; line-height: 1.8; }
  .pp-footer-links a:hover { color: #07b4ba; }
  .pp-footer-contact { display: flex; flex-direction: column; gap: 10px; }
  .pp-footer-bottom { margin-top: 24px; padding-top: 16px; border-top: 1px solid rgba(255,255,255,0.06); text-align: center; font-family: 'Barlow', sans-serif; font-size: 13px; color: rgba(255,255,255,0.3); }

  /* ── APPLY GRID ── */
  .pp-apply-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: center; }

  /* ── BONUS GRID ── */
  .pp-bonus-grid { display: grid; grid-template-columns: repeat(5, 1fr); gap: 8px; }
  ...
  @media (max-width: 900px) {
    .pp-bonus-grid { grid-template-columns: repeat(2, 1fr); }
    .pp-apply-grid { grid-template-columns: 1fr; gap: 40px; }
    .pp-problem-grid { flex-direction: column; }
    .pp-problem-right { max-width: 100%; }
    .pp-testi-main { flex-direction: column; }
    .pp-testi-img { max-width: 100%; }
  }

  @media (max-width: 768px) {
    /* Nav */
    .pp-nav { height: 56px; padding: 0 16px; }
    .pp-nav-logo { font-size: 26px; }
    .pp-nav-right { gap: 8px; }
    .pp-nav-home { display: none; }
    .pp-nav-call { height: 38px; padding: 0 16px; font-size: 14px; letter-spacing: 1px; }
    .pp-nav-home-mobile {
      ...
      color: #07b4ba; font-size: 22px;
      box-shadow: 0 10px 30px rgba(0,0,0,0.35); backdrop-filter: blur(10px);
    }

    /* Hero */
    .pp-hero { min-height: auto; padding: 100px 20px 60px; align-items: flex-start; }
    .pp-hero-h1 { font-size: clamp(34px, 9vw, 48px); line-height: 0.95; }
    .pp-hero-h2 { font-size: 12px; letter-spacing: 2px; }
    .pp-hero-desc { font-size: 14px; max-width: 100%; }
    .pp-join-btn { width: 100%; padding: 16px 24px; font-size: 18px; border-radius: 10px; justify-content: center; }

    /* Trust */
    .pp-trust-strip { padding: 12px 16px; gap: 12px; justify-content: center; }
    .pp-trust-item { width: calc(50% - 6px); justify-content: center; }
    .pp-trust-item p { font-size: 13px; letter-spacing: 0.5px; }
    .pp-trust-icon { width: 28px; height: 28px; }
    .pp-trust-icon svg { width: 20px; height: 20px; }

    /* Section */
    .pp-section { padding: 48px 18px; }

    /* Features — switch to stacked row layout */
    .pp-features-heading { font-size: 36px; margin-bottom: 32px; }
    .pp-features-grid { flex-direction: column; gap: 14px; }
    .pp-feature-card {
      width: 100%; min-height: auto; padding: 20px 18px;
      flex-direction: row; text-align: left; gap: 16px;
      background: linear-gradient(180deg,#13171d 0%,#101318 100%);
      border: 1px solid rgba(255,255,255,0.06);
    }
    .pp-feature-icon { width: 54px; height: 54px; flex-shrink: 0; }
    .pp-feature-icon svg { width: 40px; height: 40px; }
    .pp-feature-card h4 { font-size: 16px; min-height: auto; justify-content: flex-start; text-align: left; }
    ...
    /* Bonuses */
    .pp-bonus-grid { grid-template-columns: 1fr 1fr !important; }

    /* Apply */
    .pp-apply-grid { grid-template-columns: 1fr !important; gap: 36px !important; }
    .pp-apply-grid button { width: 100%; }

    /* FAQ */
    #faq > div { padding: 48px 18px !important; }
    #faq h2 { font-size: 36px !important; }
    #faq div[style*="gridTemplateColumns"] { grid-template-columns: 1fr !important; }
    #faq button { padding: 16px !important; }
    ...
    .pp-footer-inner { grid-template-columns: 1fr !important; gap: 28px !important; }
    .pp-footer-bottom { margin-top: 28px; }

    /* Testimonials */
    .pp-feedback-mobile { display: block; width: 100%; }
    .pp-feedback-mobile-list { display: flex; flex-direction: column; gap: 28px; padding: 0 4px; }
    .pp-feedback-mobile-card { width: 100%; padding: 28px 22px; border: 1px solid rgba(141,150,168,0.22); border-radius: 20px; background: #171a21; }
    .pp-feedback-mobile-stars { display: flex; gap: 8px; margin-bottom: 20px; color: #07b4ba; font-size: 24px; line-height: 1; }
    .pp-feedback-mobile-text { margin: 0 0 20px !important; color: rgba(189,195,208,0.78) !important; font-family: 'Barlow', sans-serif !important; font-size: 18px !important; font-style: italic !important; font-weight: 400 !important; line-height: 1.7 !important; }
    .pp-feedback-mobile-author { display: flex; align-items: center; gap: 14px; }
    .pp-feedback-avatar { position: relative; width: 52px; height: 52px; flex-shrink: 0; border-radius: 50%; background: #262b35; }
    .pp-feedback-avatar::before { content: ""; position: absolute; top: 14px; left: 50%; width: 10px; height: 10px; transform: translateX(-50%); border: 3px solid #929aaa; border-radius: 50%; }
    .pp-feedback-avatar::after { content: ""; position: absolute; left: 50%; bottom: 13px; width: 18px; height: 12px; transform: translateX(-50%); border: 3px solid #929aaa; border-bottom: 0; border-radius: 10px 10px 0 0; }
    .pp-feedback-mobile-author p { margin: 0 0 4px !important; color: #fff !important; font-family: 'Barlow', sans-serif !important; font-size: 16px !important; font-weight: 800 !important; line-height: 1 !important; }
    .pp-feedback-mobile-author span { color: #9da5b6; font-family: 'Barlow', sans-serif; font-size: 14px; line-height: 1; }
    .pp-feedback-mobile-nav { display: flex; justify-content: center; gap: 24px; margin-top: 32px; }
    .pp-feedback-mobile-nav button { display: flex; align-items: center; justify-content: center; width: 52px; height: 52px; border: 1.5px solid rgba(141,150,168,0.28); border-radius: 50%; background: rgba(7,10,16,0.35); color: #a6adbd; font-size: 28px; cursor: pointer; }

    /* Promise */
    .cp-new-promise { padding: 24px 20px; }
    .cp-new-promise-text { font-size: 15px; line-height: 1.8; }
    .cp-new-promise-title { font-size: 24px; }
    ...
    .pp-roadmap-mobile > div > div:first-child h2 { font-size: 36px !important; line-height: 0.9 !important; letter-spacing: 1px !important; }
    .pp-roadmap-mobile > div > div:first-child p:last-child { margin-top: 12px !important; font-size: 12px !important; }
    ...
    .pp-roadmap-card-bg { position: absolute; inset: 0; background-position: 62% center; background-size: cover; opacity: 0.62; }
    ...
    .pp-roadmap-card-body { position: relative; z-index: 2; min-height: 258px; padding: 28px 16px 16px; }
    .pp-roadmap-you { margin: 0 0 6px !important; color: #07e8ef !important; font-family: 'Bebas Neue', sans-serif !important; font-size: 12px !important; }
    ...
    .pp-roadmap-rule { width: 54px; height: 2px; margin-bottom: 28px; background: #07e8ef; box-shadow: 0 0 10px rgba(7,232,239,0.55); }
    .pp-roadmap-points { display: flex; flex-direction: column; gap: 14px; }
    .pp-roadmap-point { display: flex; align-items: center; gap: 10px; }
    .pp-roadmap-point span { display: flex; width: 14px; height: 14px; flex-shrink: 0; align-items: center; justify-content: center; border: 1px solid #07e8ef; border-radius: 50%; color: #07e8ef; font-size: 8px; }
    ...
    .pp-roadmap-arrow { position: absolute; top: 50%; z-index: 8; width: 34px; height: 34px; transform: translateY(-50%); border: 1px solid rgba(7,232,239,0.55); border-radius: 8px; background: rgba(3,11,18,0.92); color: #07e8ef; font-size: 19px; cursor: pointer; }
    .pp-roadmap-arrow:disabled { opacity: 0.35; cursor: default; }
    .pp-roadmap-arrow-left { left: 0; }
    .pp-roadmap-arrow-right { right: 0; }
    .pp-roadmap-dots { display: flex; justify-content: center; gap: 12px; margin-top: 18px; }
    ...
    .pp-roadmap-note { display: flex; align-items: center; gap: 14px; margin: 20px 16px 0; padding: 16px 18px; border: 1px solid rgba(255,255,255,0.07); border-radius: 8px; background: linear-gradient(180deg, rgba(13,26,36,0.9), rgba(7,14,22,0.92)); }
    ...
    .pp-roadmap-note h3 { margin: 0 0 5px; color: rgba(255,255,255,0.9); font-family: 'Bebas Neue', sans-serif; font-size: 16px; letter-spacing: 0.8px; line-height: 1; }
    .pp-roadmap-note p { margin: 0; color: #07e8ef; font-size: 11px; line-height: 1.3; }
  }

  @media (max-width: 480px) {
    .pp-hero-h1 { font-size: clamp(30px, 8vw, 38px); }
    .pp-trust-item { width: 100%; }
    .pp-bonus-grid { grid-template-columns: 1fr !important; }
    .pp-feature-card { padding: 16px; gap: 12px; }
    .pp-feature-icon { width: 46px; height: 46px; }
    .pp-feature-icon svg { width: 32px; height: 32px; }
    .pp-coach-stats > div { width: 100% !important; }
  }

  /* ── AOF INTRO GRID RESPONSIVE ── */
  .pp-intro-grid {
    display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: center;
  }
  @media (max-width: 768px) {
    .pp-intro-grid { grid-template-columns: 1fr !important; gap: 32px; }
    .pp-intro-grid > div:first-child { aspect-ratio: 16/9; }
  }
`;
...
const IconNutrition = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="#07b4ba" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="52" height="52">
    ...
    <>
      ...
      <div className="pp">
        ...
        <section className="pp-features">
          <div className="pp-section">
            <Reveal>
              <p style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 700, fontSize: 14, letterSpacing: 3, textTransform: "uppercase", color: "#07b4ba", marginBottom: 0, textAlign: "center" }}>
                WHAT'S INCLUDED
              </p>
            ...
            <Reveal>
              ...
              <div style={{ display: "flex", gap: 56, alignItems: "flex-start", flexWrap: "wrap" }}>
                ...
                <div style={{ flex: 1, minWidth: 260 }}>
                  <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(32px, 4vw, 48px)", letterSpacing: 2, color: "#fff", marginBottom: 4 }}>Head Coach</h2>
          ...
          <div className="pp-section" style={{ paddingTop: 48 }}>
            <Reveal>
              <div style={{ textAlign: "center", marginBottom: 44 }}>
                ...
                <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(28px,4vw,60px)", letterSpacing: 3, color: "#fff", marginTop: 8, lineHeight: 1 }}>
            ...
            <Reveal>
              <div className="pp-testi-main">
                ...
                <div style={{ flex: 1, minWidth: 260 }}>
                  <h3 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(26px,3vw,42px)", letterSpacing: 1.5, lineHeight: 1.1, marginBottom: 16, color: "#fff" }}>
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto", padding: "40px 24px" }}>
            ...
            <div className="pp-bonus-grid">
              {[
                ...
                <div key={i} style={{ background: "linear-gradient(180deg,#0e141c 0%, #0a0f14 100%)", border: "1px solid rgba(7,180,186,0.35)", borderRadius: 18, padding: "16px 12px", position: "relative", overflow: "hidden", minHeight: 220, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
                  ...
                  <div style={{ width: 70, height: 70, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 7, marginTop: 18 }}>
                    {i === 0 ? <IconNutrition /> : i === 1 ? <IconMobility /> : i === 2 ? <IconCommunity /> : i === 3 ? <IconShadowboxing /> : <IconAudio />}
                  </div>
                  <h3 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(16px, 1.8vw, 20px)", lineHeight: 1.1, letterSpacing: 1.5, color: "#fff", marginBottom: 8 }}>{item.title}</h3>
                  <div style={{ marginTop: "auto", borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 10, width: "100%" }}>
                    <p style={{ color: "#07b4ba", fontFamily: "'Bebas Neue', sans-serif", fontSize: 26, letterSpacing: 1 }}>{item.value}</p>
                  </div>
                </div>
              ))}
            </div>
            <div style={{ marginTop: 16, border: "1px solid rgba(7,180,186,0.35)", borderRadius: 18, padding: "20px 24px", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "center", gap: 20, background: "linear-gradient(90deg,#0f141a 0%, #0a0f14 100%)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                <img src="https://i.postimg.cc/pr1bYVdc/Chat-GPT-Image-May-22-2026-12-03-35-AM.png" alt="Gift Box" style={{ width: 80, height: 80, objectFit: "contain", filter: "drop-shadow(0 0 10px rgba(255,215,0,0.35))" }} />
                <div>
                  <p style={{ fontFamily: "'Barlow', sans-serif", color: "rgba(255,255,255,0.5)", fontSize: 13, letterSpacing: 1, marginBottom: 4 }}>TOTAL BONUS VALUE</p>
                  <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(32px, 4vw, 46px)", lineHeight: 1, letterSpacing: 2, color: "#07b4ba" }}>₹7,499</h2>
                </div>
              </div>
              <div style={{ paddingLeft: 24, borderLeft: "1px solid rgba(255,255,255,0.14)", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                <p style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(28px, 3.5vw, 40px)", letterSpacing: 2, color: "#fff", lineHeight: 1 }}>YOURS 100% FREE</p>
                <p style={{ fontFamily: "'Barlow', sans-serif", fontSize: 15, color: "rgba(255,255,255,0.68)", marginTop: 10 }}>When you join the AOF 30-Day MMA Striking Program.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="pp-section">
            <div className="pp-apply-grid">
              <div>
                ...
                <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(30px,5vw,54px)", lineHeight: 1, letterSpacing: 2, color: "#fff", marginBottom: 20 }}>
                  APPLY FOR YOUR <br /><span style={{ color: "#07b4ba" }}>30-DAY PROGRAM</span>
                </h2>
                <p style={{ fontFamily: "'Barlow', sans-serif", color: "rgba(255,255,255,0.52)", fontSize: 14, lineHeight: 1.7, marginBottom: 20, maxWidth: 380 }}>
                ...
                <button style={{ display: "inline-flex", alignItems: "center", gap: 10, height: 52, padding: "0 24px", borderRadius: 999, border: "none", background: "#25D366", color: "#fff", fontFamily: "'Barlow', sans-serif", fontWeight: 700, fontSize: 15, cursor: "pointer", boxShadow: "0 4px 18px rgba(37,211,102,0.35)" }}>
              ...
              <div style={{ background: "#05070b", borderRadius: 20, border: "1px solid rgba(255,255,255,0.08)", padding: "32px 28px", textAlign: "center", boxShadow: "0 0 30px rgba(0,0,0,0.4)" }}>
                ...
                <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(32px,5vw,60px)", lineHeight: 0.95, letterSpacing: 2, marginBottom: 20, color: "#fff" }}>
